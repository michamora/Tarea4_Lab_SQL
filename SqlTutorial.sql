...
-- Aprendiendo Sql en dos semanas | Tarea 4 Laboratorio
-- Michael Mora Ortega
...
--4
select nombre+space(1)+upper(apellido) as nombre, stuff(documento,1,0,'DNI N� ') as documento, stuff(sueldo,1,0,'$ ') as sueldo from empleados;
--5
...
-- 43 - Registros duplicados (distinct)         #38
--PRIMER PROBLEMA--
--1
if object_id('clientes') is not null
	drop table clientes;
...
-- 53 - Eliminar restricciones (alter table - drop)           #40
--PRIMER PROBLEMA--
--1
...
-- 65 - Trabajar con varias tablas          #41
--LISTO

-- 66 - Combinaci�n interna (inner join)         #42
--PRIMER PROBLEMA--
--1
if (object_id('clientes')) is not null
	drop table clientes;
...
-- 67- Combinaci�n externa izquierda (left join)         #43
--PRIMER PROBLEMA--
--1
if (object_id('clientes')) is not null
	drop table clientes;
...
-- 68 - Combinaci�n externa derecha (right join)          #44
--PRIMER PROBLEMA--
--1
if (object_id('clientes')) is not null
	drop table clientes;
...
-- 45 -Combinaci�n externa completa (full join)             #45
--PRIMER PROBLEMA--
--1
...
-- 70 -Combinaciones cruzadas (cross join)      #46
--PRIMER PROBLEMA--
--1
...
-- 73 - Combinaci�n de m�s de dos tablas          #47
--Primer problema
...
-- 74 - Combinaciones con update y delete          #48
--LISTO
...
-- 83 - Agregar y eliminar campos ( alter table - add - drop)         #51
--PRIMER PROBLEMA
if object_id('empleados') is not null
  drop table empleados;
...
-- 84 -Alterar campos (alter table - alter)           #52
--PRIMER PROBLEMA
if object_id('empleados') is not null
  drop table empleados;
...
-- 92 -Subconsultas como expresi�n           #55
--PRIMER PROBLEMA
 if object_id('alumnos') is not null
  drop table alumnos;
...
-- 94 -Subconsultas any - some - all         #57
--PRIMER PROBLEMA
if object_id('inscriptos') is not null
  drop table inscriptos;
 if object_id('socios') is not null
...
--95 -Subconsultas correlacionadas         #58
--PRIMER PROBLEMA
if object_id('inscriptos') is not null
  drop table inscriptos;
 if object_id('socios') is not null
...
-- 98 -Subconsulta en lugar de una tabla        #60
--PRIMER PROBLEMA
if object_id('inscriptos') is not null
  drop table inscriptos;
if object_id('socios') is not null
...
-- 99 -Subconsulta (update - delete)     #61
--PRIMER PROBLEMA
if object_id('inscriptos') is not null
  drop table inscriptos;
if object_id('socios') is not null
...
(
 ...
 -- 101 - Crear tabla a partir de otra (select - into)          #63
--PRIMER PROBLEMA
if object_id('empleados')is not null
  drop table empleados;
...
-- 104 - Vistas (informaci�n)       #66

--LISTO

--110 - Lenguaje de control de flujo (case)    #67
--PRIMER PROBLEMA
if object_id('empleados') is not null
  drop table empleados;
...
--111-Lenguaje de control de flujo (if)         #68
--PRIMER PROBLEMA
if object_id('empleados') is not null
  drop table empleados;
...
(
 ...
 -- 119 - Procedimientos almacenados      #69
--LISTO

-- 120 - Procedimientos almacenados (crear - ejecutar)         #70
--PRIMER PROBLEMA
if object_id('empleados') is not null
  drop table empleados;
...
exec pa_empleados_hijos;
-- 132 -Tablas temporales      #71
--LISTO

-- 133 - Funciones        #72
--LISTO

-- 135 - Funciones escalares (crear y llamar)        #73
--PRIMER PROBLEMA
...
if object_id('f_valorNulo') is not null
 ...
 select documento,nombre,fechanacimiento,
  ...
  from empleados;
-- 136 -Funciones de tabla de varias instrucciones          #74
--PRIMER PROBLEMA
if object_id('empleados') is not null
  drop table empleados;
...
-- 137 - Funciones con valores de tabla en l�nea           #75
--LISTO